 ...
 */
class Satisfaction extends \MyApp\ApBundle\Entity\Satisfaction implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'user', 'appel', 'equipe', 'service', 'peinture', 'question', 'created', 'updated', 'dateTable');
    }
