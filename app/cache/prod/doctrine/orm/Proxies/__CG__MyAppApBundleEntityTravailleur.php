 ...
 */
class Travailleur extends \MyApp\ApBundle\Entity\Travailleur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setNas($nas);
    }

    public function getNas()
    {
        $this->__load();
        return parent::getNas();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'nom', 'prenom', 'cell', 'nas', 'utilisateur');
    }
